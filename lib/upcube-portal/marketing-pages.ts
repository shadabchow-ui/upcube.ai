...
const appLinks = [
  { title: "Upcube Chat", href: UPCUBE_CHAT_URL },
  { title: "Upcube Globe / Planet", href: UPCUBE_PLANET_URL },
...
export const platformPageContent: MarketingPageContent = {
    ...
    primaryCta: { label: "Open Upcube Chat", href: UPCUBE_CHAT_URL, external: true },
    ...
    sections: [
      {
        ...
        cards: [
          ...
          {
            title: "Domain apps",
            body: "Globe, Books, Jobs, Games, and Cloud are connected through one navigation model.",
            href: "/explore",
          },
          {
            title: "Portal layer",
      ...
      },
      {
        ...
        cards: [
          { title: "Product planning", body: "Spec drafts, tradeoff notes, and launch checklists." },
          { title: "Research synthesis", body: "Evidence mapping and decision-ready summaries." },
          { title: "Creative production", body: "Cross-format ideation for writing and media workflows." },
        ],
      },
    ],
};
...
export const businessPageContent: MarketingPageContent = {
    ...
    secondaryCta: { label: "Open cloud tools", href: UPCUBE_CLOUD_URL, external: true },
    sections: [
      {
      ...
      },
      {
        ...
        cards: [
          { title: "Hiring pipeline", body: "Route hiring workflows to Upcube Jobs.", href: UPCUBE_JOBS_URL, external: true },
          { title: "Knowledge publishing", body: "Route editorial and learning workflows to Upcube Books.", href: UPCUBE_BOOKS_URL, external: true },
          { title: "Developer delivery", body: "Route implementation workflows to Upcube Cloud.", href: UPCUBE_CLOUD_URL, external: true },
        ],
      },
    ],
};
...
export const capabilitiesPageContent: MarketingPageContent = {
    ...
    primaryCta: { label: "Open chat workspace", href: UPCUBE_CHAT_URL, external: true },
    ...
    sections: [
      {
        ...
        cards: [
          { title: "Prompted planning", body: "Generate structured plans, checklists, and execution drafts." },
          { title: "Research summarization", body: "Convert source inputs into concise decision-oriented outputs." },
          { title: "Cross-app routing", body: "Move from portal context into Globe, Books, Jobs, Games, or Cloud." },
        ],
      },
      {
        ...
        cards: [
          { title: "Research to memo", body: "Start in chat, validate on /research, ship an internal summary." },
          { title: "Idea to launch plan", body: "Draft launch tracks, owners, and review points in one workspace." },
          { title: "Builder support", body: "Route coding and developer preparation into Upcube Cloud.", href: UPCUBE_CLOUD_URL, external: true },
        ],
      },
    ],
};
    ...
    sections: [
      {
        ...
        cards: [
          { title: "Operations planning", body: "Draft process docs, rollout plans, and issue triage summaries." },
          { title: "Knowledge enablement", body: "Prepare internal briefs and orientation material for teams." },
          { title: "Execution coordination", body: "Route actionable tracks to the right Upcube app by function." },
        ],
      },
      {
        ...
        cards: [
          { title: "Upcube Chat", body: "Primary workspace for task planning and synthesis.", href: UPCUBE_CHAT_URL, external: true },
          { title: "Upcube Cloud", body: "Developer and implementation support entry.", href: UPCUBE_CLOUD_URL, external: true },
          { title: "Upcube Jobs", body: "Hiring and role workflow destination.", href: UPCUBE_JOBS_URL, external: true },
        ],
      },
    ],
};
...
export const researchPageContent: MarketingPageContent = {
    ...
    primaryCta: { label: "Open chat for research", href: UPCUBE_CHAT_URL, external: true },
    ...
    sections: [
      {
        ...
        cards: [
          { title: "Research briefs", body: "Concise summaries with assumptions and open questions." },
          { title: "Comparative notes", body: "Option-by-option comparisons to support decision meetings." },
          { title: "Execution prompts", body: "Action-ready next-step tracks for product and operations teams." },
        ],
      },
      {
        ...
        cards: [
          { title: "Spatial research", body: "Continue location and mapping exploration in Upcube Globe.", href: UPCUBE_PLANET_URL, external: true },
          { title: "Publishing flow", body: "Move editorial research outputs toward Upcube Books.", href: UPCUBE_BOOKS_URL, external: true },
          { title: "Developer follow-through", body: "Move technical implementation tracks into Upcube Cloud.", href: UPCUBE_CLOUD_URL, external: true },
        ],
      },
    ],
};

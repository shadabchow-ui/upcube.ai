...
var define_IMAGES_REMOTE_PATTERNS_default = [{ protocol: "https", hostname: "^(?:^(?:cdn\\.shopify\\.com)$)$", pathname: "^(?:\\/s\\/files(?:\\/(?!\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?)|$))$" }];
...
// node_modules/.pnpm/@opennextjs+cloudflare@1.19.10_next@15.6.0-canary.60_react-dom@19.0.0_react@19.0.0__react@19.0.0__wrangler@4.92.0/node_modules/@opennextjs/cloudflare/dist/cli/templates/images.js

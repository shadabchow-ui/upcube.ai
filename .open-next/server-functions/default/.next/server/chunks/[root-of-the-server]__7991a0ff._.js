    ...
    function s(e) {
      ...
      e)) {
        ...
        (i += "<url>\n"),
          (i += `<loc>${l.url}</loc>
`);
        let e = null == (n = l.alternates) ? void 0 : n.languages;
        if (e && Object.keys(e).length)
          for (let t in e)
            i += `<xhtml:link rel="alternate" hreflang="${t}" href="${e[t]}" />
`;
        if (null == (a = l.images) ? void 0 : a.length)
...
`),
  ...
  (e) => {
    ...
    async function b() {
      let e = await w(),
        t = (0, _.resolveRouteData)(e, "robots");
    ...
    let O = new t.AppRouteRouteModule({
      ...
      { workAsyncStorage: A, workUnitAsyncStorage: $, serverHooks: C } = O;
    function S() {
    ...
    async function T(e, t, o) {
      var y;
      let R = "/robots.txt/route";
      R = R.replace(/\/index$/, "") || "/";
      let w = await O.prepare(e, t, { srcPage: R, multiZoneDraftMode: !1 });
      if (!w)
        return (
          (t.statusCode = 400),
          t.end("Bad Request"),
      ...
      let D = e.method || "GET",
        ...
        L = {
          ...
          renderOpts: {
            ...
            onInstrumentationRequestError: (t, r, o) =>
              O.onRequestError(e, t, o, C),
          },
        ...
        let a = async (e) =>
          ...
          s = async (n) => {
            ...
            let d = async ({ previousCacheEntry: r }) => {
                try {
                  if (!(0, i.getRequestMeta)(e, "minimalMode") && S && T && !r)
                    return (
                      (t.statusCode = 404),
            ...
            return (
              ((0, i.getRequestMeta)(e, "minimalMode") && k) ||
                c.delete(m.NEXT_CACHE_TAGS_HEADER),
              !u.cacheControl ||
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7991a0ff._.js.map

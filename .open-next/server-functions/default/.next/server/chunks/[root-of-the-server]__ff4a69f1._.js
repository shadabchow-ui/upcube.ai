...
`);
  ...
  (e) => {
    ...
    let O = new t.AppRouteRouteModule({
      ...
      { workAsyncStorage: C, workUnitAsyncStorage: y, serverHooks: _ } = O;
    function T() {
    ...
    async function A(e, t, a) {
      var f;
      let g = "/api/revalidate/route";
      g = g.replace(/\/index$/, "") || "/";
      let w = await O.prepare(e, t, { srcPage: g, multiZoneDraftMode: !1 });
      if (!w)
        return (
          (t.statusCode = 400),
          t.end("Bad Request"),
      ...
      let {
        ...
        M = !!(A.dynamicRoutes[q] || A.routes[N]);
      if (M && !T) {
        let e = !!A.routes[N],
          t = A.dynamicRoutes[q];
        if (t && !1 === t.fallback && !e) throw new m.NoFallbackError();
      }
      let j = null;
      !M || O.isDev || T || (j = "/index" === (j = N) ? "/" : j);
      let H = !0 === O.isDev || !M,
        U = M && !H;
      k &&
        I &&
      ...
      let D = e.method || "GET",
        ...
        K = {
          ...
          renderOpts: {
            experimental: {
              cacheComponents: !!_.experimental.cacheComponents,
            ...
            cacheLifeProfiles:
              null == (f = _.experimental) ? void 0 : f.cacheLife,
      ...
      try {
        let i = async (e) =>
          ...
          o = async (s) => {
            ...
            let d = async ({ previousCacheEntry: r }) => {
                try {
                  if (!(0, n.getRequestMeta)(e, "minimalMode") && b && P && !r)
                    return (
                      (t.statusCode = 404),
            ...
            return (
              ((0, n.getRequestMeta)(e, "minimalMode") && M) ||
                p.delete(R.NEXT_CACHE_TAGS_HEADER),
              !u.cacheControl ||
        ...
        if (
          ...
          throw t;
        return (
          await (0, h.sendResponse)(L, Y, new Response(null, { status: 500 })),
          null
        );
      }
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ff4a69f1._.js.map

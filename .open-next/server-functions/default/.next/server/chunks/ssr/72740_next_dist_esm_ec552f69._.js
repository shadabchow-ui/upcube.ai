module.exports = [
  ...
  (a) => {
    ...
    a.s(["error", () => t, "warn", () => u, "warnOnce", () => w], 52293);
  },
  51369,
  34278,
  (a) => {
  ...
  (a) => {
    ...
    let K = (a, b) => {
        "object" == typeof b && null !== b && b instanceof J && b.bubble
      ...
      P =
        ((c = new (class a {
          ...
          trace(...a) {
            ...
            let [c, d, e] = a,
              ...
              h = g.spanName ?? c;
            if (
              (!B.includes(c) && "1" !== process.env.NEXT_OTEL_VERBOSE) ||
              g.hideSpan
            )
              return f();
            let i = this.getSpanContext(
              ...
              j = !1;
            i
              ? (null == (b = F.getSpanContext(i)) ? void 0 : b.isRemote) &&
                (j = !0)
              : ((i = (null == D ? void 0 : D.active()) ?? I), (j = !0));
            let k = N++;
            return (
              (g.attributes = {
                "next.span_name": h,
              ...
              D.with(i.setValue(M, k), () =>
                this.getTracerInstance().startActiveSpan(h, g, (a) => {
                  ...
                  j && L.set(k, new Map(Object.entries(g.attributes ?? {})));
                  try {
                    if (f.length > 1) return f(a, (b) => K(a, b));
                    let b = f(a);
                    if (
                      null !== b &&
                      "object" == typeof b &&
          ...
          wrap(...a) {
            ...
            return B.includes(c) || "1" === process.env.NEXT_OTEL_VERBOSE
              ? function () {
                  let a = d;
                  "function" == typeof a &&
                    "function" == typeof e &&
                  ...
                  {
                    let d = b.getContext().bind(D.active(), g);
                    return b.trace(
                      c,
                      a,
                      (a, b) => (
        ...
        () => c);
    a.s(
      ["SpanKind", () => H, "SpanStatusCode", () => G, "getTracer", () => P],
      74367,
    );
  },
  71869,
  ...
  (a) => {
    "use strict";
    a.i(74367), a.i(19254), a.i(28643), a.i(71272);
    let b = {
      OPENING: {
  ...
  (a) => {
    ...
    a.s(["NEXT_REQUEST_META", 0, b, "getRequestMeta", () => c]);
  },
  35054,
  (a) => {
    "use strict";
  ...
  (a) => {
    ...
    a.i(35054),
      ...
      a.s(["detectDomainLocale", () => e], 30200);
  },
  76641,
  5383,
  (a) => {
    ...
    a.s(["removeTrailingSlash", () => b], 76641),
      a.s(["parsePath", () => c], 5383);
  },
  77909,
  59788,
  (a) => {
    ...
    a.s(["addPathPrefix", () => c], 77909),
      a.s(["addPathSuffix", () => d], 59788);
  },
  93649,
  (a) => {
    "use strict";
  ...
  (a) => {
    ...
    a.s(["formatNextPathnameInfo", () => f], 7678),
      a.s(["getHostname", () => g], 58260);
    let h = new WeakMap();
    function i(a, b) {
      let c;
    ...
    a.s(["normalizeLocalePath", () => i], 95335);
  },
  97673,
  (a) => {
    "use strict";
  ...
  (a) => {
    ...
    a.s(["isAbortError", () => t, "pipeToNodeResponse", () => u], 54218);
  },
  17651,
  (a) => {
    "use strict";
  ...
  (a) => {
    ...
    a.s(["default", () => e], 49392), a.i(50592), a.i(35054), a.s([], 34079);
  },
];

//# sourceMappingURL=72740_next_dist_esm_ec552f69._.js.map

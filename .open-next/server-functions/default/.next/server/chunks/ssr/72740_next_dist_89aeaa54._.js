module.exports = [
  ...
  (a, b, c) => {
    ...
    let h = (d = a.r(83839)) && d.__esModule ? d : { default: d },
      i = a.r(7062),
      j = a.r(52044),
      k = a.r(32319),
      l = a.r(56704),
    ...
    function v(a, b, c) {
      ...
      if (!a.forceDynamic && !a.forceStatic) {
        ...
        if (b)
          switch (b.type) {
            case "prerender-ppr":
              return D(a.route, c, b.dynamicTracking);
    ...
    function C({ reason: a, route: b }) {
      let c = k.workUnitAsyncStorage.getStore();
      D(b, a, c && "prerender-ppr" === c.type ? c.dynamicTracking : null);
    }
    function D(a, b, c) {
      (function () {
        if (!r)
        ...
        h.default.unstable_postpone(E(a, b));
    }
    function E(a, b) {
...
${b}`
    ...
    function Q(a) {
      ...
      if (b && c)
        switch (c.type) {
          ...
          case "prerender-ppr": {
            let d = c.fallbackRouteParams;
            if (d && d.size > 0) return D(b.route, a, c.dynamicTracking);
            break;
          }
          case "prerender-runtime":
            throw Object.defineProperty(
  ...
  - Rerun the production build with \`next build --debug-prerender\` to generate better stack traces.`));
    ...
    function $(a, b, c, d) {
      if (d.syncDynamicErrorWithStack)
        throw (
          (Z(a, d.syncDynamicErrorWithStack), new j.StaticGenBailoutError())
        );
      if (0 !== b) {
        if (c.hasSuspenseAboveBody) return;
        let d = c.dynamicErrors;
        if (d.length > 0) {
          for (let b = 0; b < d.length; b++) Z(a, d[b]);
...
//# sourceMappingURL=72740_next_dist_89aeaa54._.js.map

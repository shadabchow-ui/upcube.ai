module.exports = [
  ...
  (a, b, c) => {
    ...
    function n(a, b, c, d, e, k = {}) {
      ...
      (0, i.removeTrailingSlash)(a).slice(1).split("/"))) {
        let a = g.INTERCEPTION_ROUTE_MARKERS.some((a) => l.startsWith(a)),
          i = l.match(j.PARAMETER_PATTERN);
        if (a && i && i[2]) {
          let {
            key: a,
            pattern: c,
            ...
            segment: i[2],
            routeKeys: p,
            keyPrefix: b ? f.NEXT_INTERCEPTION_MARKER_PREFIX : void 0,
            backreferenceDuplicateKeys: e,
          });
          q.push(c),
            r.push(`/${i[1]}:${k[a] ?? d}${g ? (h ? "*" : "+") : ""}`),
            (k[a] ??= d);
        } else if (i && i[2]) {
          d &&
            i[1] &&
            (q.push(`/${(0, h.escapeStringRegexp)(i[1])}`), r.push(`/${i[1]}`));
          let {
              key: a,
              pattern: c,
              cleanedKey: g,
              ...
              segment: i[2],
              routeKeys: p,
              keyPrefix: b ? f.NEXT_QUERY_PARAM_PREFIX : void 0,
              backreferenceDuplicateKeys: e,
            }),
            n = c;
          d && i[1] && (n = n.substring(1)),
            q.push(n),
            r.push(`/:${k[a] ?? g}${j ? (l ? "*" : "+") : ""}`),
            (k[a] ??= g);
        ...
        c &&
          i &&
          i[3] &&
          (q.push((0, h.escapeStringRegexp)(i[3])), r.push(i[3]));
      }
      return {
  ...
  (a, b, c) => {
    ...
    let g = a.r(81935),
      h = (d = a.r(70106)) && d.__esModule ? d : { default: d },
      i = a.r(76443),
      j = a.r(36645),
      k = a.r(4674),
      l = a.r(34937),
...
//# sourceMappingURL=72740_next_dist_5afe7f47._.js.map

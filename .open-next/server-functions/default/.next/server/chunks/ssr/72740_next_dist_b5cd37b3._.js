  ...
  (a) => {
        ...
        "",
        {
          children: [
            ...
            {},
            {
              ...
              page: [
                () => a.r(30621),
                "[project]/node_modules/.pnpm/next@15.6.0-canary.60_react-dom@19.0.0_react@19.0.0__react@19.0.0/node_modules/next/dist/client/components/builtin/app-error.js",
              ],
            },
          ],
        },
    ...
    async function L(a, b, c) {
      ...
      let {
        ...
        aj = (0, u.getBotType)(ai),
        ak = (0, p.isHtmlBotRequest)(a),
        al =
          (0, h.getRequestMeta)(a, "isPrefetchRSCRequest") ??
          "1" === a.headers[t.NEXT_ROUTER_PREFETCH_HEADER],
        am =
          (0, h.getRequestMeta)(a, "isRSCRequest") ?? !!a.headers[t.RSC_HEADER],
        an = (0, s.getIsPossibleServerAction)(a),
        ao =
        ...
        ap = !1,
        aq = !1,
        ar = ao ? (0, h.getRequestMeta)(a, "postponed") : void 0,
        as = ao && am && !al,
        at = (0, h.getRequestMeta)(a, "segmentPrefetchRSCRequest"),
        au =
          (!ak || !ao) &&
          (!ai || (0, p.shouldServeStreamingMetadata)(ai, ac.htmlLimitedBots)),
        ...
        ax =
          ...
          !av ||
          "string" == typeof ar ||
          (aw && (0, h.getRequestMeta)(a, "onCacheEntryV2") ? as && !N : as),
        ay = ak && ao,
        az = null;
      $ || !av || ax || an || ar || as || (az = _);
      let aA = az;
          ...
          m = async ({
            ...
            let l = {
              ...
              renderOpts: {
                ...
                pageConfig: {},
                ComponentMod: aB,
                Component: (0, j.interopDefault)(aB),
                params: R,
                routeModule: K,
                page: M,
                postponed: e,
                ...
                supportsDynamicResponse: "string" == typeof e || ax,
                buildManifest: T,
                nextFontManifest: U,
                reactLoadableManifest: V,
                subresourceIntegrityManifest: Y,
            ...
            ap &&
              ...
              (l.renderOpts.isDebugDynamicAccesses = ap)),
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
          ...
          o = async ({
            ...
            if (
              (ag && (l = (0, w.parseFallbackField)(ag.fallback)),
              l === w.FallbackMode.PRERENDER &&
                (0, u.isBot)(ai) &&
                (!ao || ak) &&
                (l = w.FallbackMode.BLOCKING_STATIC_RENDER),
              (null == f ? void 0 : f.isStale) === -1 && (af = !0),
              af &&
              ...
              if ((p || ag) && l === w.FallbackMode.NOT_FOUND)
                throw new B.NoFallbackError();
              if (ao && (ac.experimental.clientParamParsing ? !as : !am)) {
                let b =
                    p && "string" == typeof (null == ag ? void 0 : ag.fallback)
                      ? ag.fallback
                      : ae,
                  d =
                    p && (null == ag ? void 0 : ag.fallbackRouteParams)
                      ? (0, n.createOpaqueFallbackRouteParams)(
                          ag.fallbackRouteParams,
                        )
                      : aq
                        ? (0, n.getFallbackRouteParams)(ae, K)
                        : null,
            ...
            let s =
              ...
              (0, h.getRequestMeta)(a, "renderFallbackShell")
                ? (0, n.createOpaqueFallbackRouteParams)(ag.fallbackRouteParams)
                : aq
                  ? (0, n.getFallbackRouteParams)(ae, K)
                  : null;
            return m({
          ...
          p = async (d) => {
                ...
                if (n.cacheControl)
                  if ("number" == typeof n.cacheControl.revalidate) {
                    ...
                    l = {
                      ...
                      expire:
                        (null == (j = n.cacheControl) ? void 0 : j.expire) ??
                        ac.expireTime,
                    };
            ...
            if (
              ...
              let c =
                null == (k = q.headers) ? void 0 : k[y.NEXT_CACHE_TAGS_HEADER];
              N &&
                av &&
                c &&
                "string" == typeof c &&
            ...
            let s =
              null == (g = q.headers) ? void 0 : g[y.NEXT_CACHE_TAGS_HEADER];
            if (
              (N &&
                av &&
                s &&
              ...
              !N &&
                ...
                am &&
                (b.statusCode = 200),
              p && !as && b.setHeader(t.NEXT_DID_POSTPONE_HEADER, "1"),
              am && !$)
            ) {
              if (void 0 === q.rscData) {
    ...
    a.s(["__next_app__", 0, J, "handler", () => L, "routeModule", 0, K], 63529),
      a.i(63529),
      a.s(
        [
          "ClientPageRoot",
...
//# sourceMappingURL=72740_next_dist_b5cd37b3._.js.map

module.exports = [
  ...
  (a) => {
    ...
    let J = [
          ...
          children: [
            "search",
            {
              children: [
                ...
                {
                  metadata: {},
                  page: [() => a.r(17863), "[project]/app/search/page.tsx"],
                },
              ],
            },
            {
              metadata: {},
              layout: [() => a.r(36877), "[project]/app/search/layout.tsx"],
              loading: [() => a.r(88467), "[project]/app/search/loading.tsx"],
            },
          ],
        },
        {
      ...
      K = { require: a.r.bind(a), loadChunk: a.l.bind(a) },
      L = new e.AppPageRouteModule({
        definition: {
          kind: f.RouteKind.APP_PAGE,
          page: "/search/page",
          pathname: "/search",
          bundlePath: "",
          filename: "",
    ...
    async function M(a, b, c) {
      ...
      let e = "/search/page";
      e = e.replace(/\/index$/, "") || "/";
      let N = (0, i.getRequestMeta)(a, "minimalMode"),
        O = await L.prepare(a, b, { srcPage: e, multiZoneDraftMode: !1 });
      if (!O)
        return (
          (b.statusCode = 400),
          b.end("Bad Request"),
      ...
      let {
        ...
        ae = (0, s.normalizeAppPath)(e),
        { isOnDemandRevalidate: af } = O,
        ag =
          ac.experimental.ppr &&
          !ac.experimental.cacheComponents &&
          (0, I.isInterceptionRouteAppPath)(_)
            ? null
            : L.match(_, Z),
        ah = !!Z.routes[_],
        ai = a.headers["user-agent"] || "",
        aj = (0, v.getBotType)(ai),
        ak = (0, q.isHtmlBotRequest)(a),
        al =
          (0, i.getRequestMeta)(a, "isPrefetchRSCRequest") ??
          "1" === a.headers[u.NEXT_ROUTER_PREFETCH_HEADER],
        am =
          (0, i.getRequestMeta)(a, "isRSCRequest") ?? !!a.headers[u.RSC_HEADER],
        an = (0, t.getIsPossibleServerAction)(a),
        ao =
          (0, n.checkIsAppPPREnabled)(ac.experimental.ppr) &&
          (null == (d = Z.routes[ae] ?? Z.dynamicRoutes[ae])
            ? void 0
            : d.renderingMode) === "PARTIALLY_STATIC",
        ap = !1,
        aq = !1,
        ar = ao ? (0, i.getRequestMeta)(a, "postponed") : void 0,
        as = ao && am && !al,
        at = (0, i.getRequestMeta)(a, "segmentPrefetchRSCRequest"),
        au =
          (!ak || !ao) &&
          (!ai || (0, q.shouldServeStreamingMetadata)(ai, ac.htmlLimitedBots)),
        ...
        ax =
          ...
          !av ||
          "string" == typeof ar ||
          (aw && (0, i.getRequestMeta)(a, "onCacheEntryV2") ? as && !N : as),
        ay = ak && ao,
        az = null;
      $ || !av || ax || an || ar || as || (az = _);
      let aA = az;
      !aA && L.isDev && (aA = _),
        L.isDev ||
          ...
          !am ||
          as ||
          (0, l.stripFlightHeaders)(a.headers);
      let aB = {
        ...E,
        tree: J,
        GlobalError: D.default,
        handler: M,
        routeModule: L,
        __next_app__: K,
      };
      ...
      try {
        let d = L.getVaryHeader(_, ad);
        b.setHeader("Vary", d);
        let g = async (c, d) => {
            let f = new m.NodeNextRequest(a),
              g = new m.NodeNextResponse(b);
            return L.render(f, g, d).finally(() => {
              if (!c) return;
              c.setAttributes({
              ...
              if (!a) return;
              if (a.get("next.span_type") !== j.BaseServerSpan.handleRequest)
          ...
          l = (0, i.getRequestMeta)(a, "incrementalCache"),
          n = async ({
            span: d,
            postponed: f,
            ...
            let m = {
              ...
              serverComponentsHmrCache: (0, i.getRequestMeta)(
                a,
              ...
              renderOpts: {
                ...
                pageConfig: {},
                ComponentMod: aB,
                Component: (0, k.interopDefault)(aB),
                params: R,
                routeModule: L,
                page: e,
                postponed: f,
                ...
                dir: require("path").join(process.cwd(), L.relativeProjectDir),
                isDraftMode: $,
                botType: aj,
                ...
                onInstrumentationRequestError: (b, c, d) =>
                  L.onRequestError(a, b, d, ab),
                err: (0, i.getRequestMeta)(a, "invokeError"),
                dev: L.isDev,
              },
            };
            ap &&
              ((m.renderOpts.nextExport = !0),
              (m.renderOpts.supportsDynamicResponse = !1),
              (m.renderOpts.isDebugDynamicAccesses = ap)),
              j && (m.renderOpts.supportsDynamicResponse = !1);
            let n = await g(d, m),
              { metadata: o } = n,
              {
                cacheControl: p,
            ...
            if (
              (r && (q[z.NEXT_CACHE_TAGS_HEADER] = r),
              (a.fetchMetrics = s),
              av &&
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
          ...
          p = async ({
            ...
            if (
              (ag && (k = (0, x.parseFallbackField)(ag.fallback)),
              k === x.FallbackMode.PRERENDER &&
                (0, v.isBot)(ai) &&
                (!ao || ak) &&
                (k = x.FallbackMode.BLOCKING_STATIC_RENDER),
              (null == e ? void 0 : e.isStale) === -1 && (af = !0),
              af &&
                (k !== x.FallbackMode.NOT_FOUND || e) &&
                (k = x.FallbackMode.BLOCKING_STATIC_RENDER),
              !N &&
                k !== x.FallbackMode.BLOCKING_STATIC_RENDER &&
                aA &&
              ...
              if ((m || ag) && k === x.FallbackMode.NOT_FOUND)
                throw new C.NoFallbackError();
              if (ao && (ac.experimental.clientParamParsing ? !as : !am)) {
                let b =
                    m && "string" == typeof (null == ag ? void 0 : ag.fallback)
                      ? ag.fallback
                      : ae,
                  d =
                    m && (null == ag ? void 0 : ag.fallbackRouteParams)
                      ? (0, o.createOpaqueFallbackRouteParams)(
                          ag.fallbackRouteParams,
                        )
                      : aq
                        ? (0, o.getFallbackRouteParams)(ae, L)
                        : null,
                  e = await L.handleResponse({
                    cacheKey: b,
                    req: a,
                    nextConfig: ac,
                    routeKind: f.RouteKind.APP_PAGE,
                    isFallback: !0,
                    prerenderManifest: Z,
                    isRoutePPREnabled: ao,
            ...
            let r = af || g || !ar ? void 0 : ar;
            if (aw && !N && l && as && !j) {
              let b = await l.get(_, {
                kind: w.IncrementalCacheKind.APP_PAGE,
                isRoutePPREnabled: !0,
                isFallback: !1,
                allowStale: !0,
              });
              b &&
                b.value &&
                b.value.kind === w.CachedRouteKind.APP_PAGE &&
                ((r = b.value.postponed),
                b &&
            ...
            let s =
              ...
              (0, i.getRequestMeta)(a, "renderFallbackShell")
                ? (0, o.createOpaqueFallbackRouteParams)(ag.fallbackRouteParams)
                : aq
                  ? (0, o.getFallbackRouteParams)(ae, L)
                  : null;
            return n({
          ...
          q = async (d) => {
            ...
            let l,
              m = await L.handleResponse({
                cacheKey: az,
                responseGenerator: (a) => p({ span: d, ...a }),
                routeKind: f.RouteKind.APP_PAGE,
                isOnDemandRevalidate: af,
                isRoutePPREnabled: ao,
                req: a,
            ...
            let o = "string" == typeof m.value.postponed;
            av &&
              !as &&
              (!o || al) &&
              (N ||
            ...
            let { value: q } = m;
            if (ar) l = { revalidate: 0, expire: void 0 };
            else if (as) l = { revalidate: 0, expire: void 0 };
            else if (!L.isDev)
            ...
            if (
              ...
              let c =
                null == (k = q.headers) ? void 0 : k[z.NEXT_CACHE_TAGS_HEADER];
              N &&
                av &&
                c &&
                "string" == typeof c &&
                b.setHeader(z.NEXT_CACHE_TAGS_HEADER, c);
              let d = q.segmentData.get(at);
              return void 0 !== d
            ...
            let r = aw
              ? ((0, i.getRequestMeta)(a, "onCacheEntryV2") ??
                (0, i.getRequestMeta)(a, "onCacheEntry"))
              : (0, i.getRequestMeta)(a, "onCacheEntry");
            if (
              r &&
              (await r(m, {
                url: (0, i.getRequestMeta)(a, "initURL") ?? a.url,
              }))
            )
              return null;
            if (q.headers) {
            ...
            let s =
              null == (g = q.headers) ? void 0 : g[z.NEXT_CACHE_TAGS_HEADER];
            if (
              (N &&
                av &&
                s &&
              ...
              !q.status || (am && ao) || (b.statusCode = q.status),
              !N &&
                q.status &&
                F.RedirectStatusCode[q.status] &&
                am &&
                (b.statusCode = 200),
              o && !as && b.setHeader(u.NEXT_DID_POSTPONE_HEADER, "1"),
              am && !$)
            ) {
              if (void 0 === q.rscData) {
                if (q.html.contentType !== u.RSC_CONTENT_TYPE_HEADER)
        ...
        if (!aE)
          return await aD.withPropagatedContext(a.headers, () =>
            aD.trace(
              j.BaseServerSpan.handleRequest,
              {
                spanName: `${aC} ${e}`,
          ...
          (b instanceof C.NoFallbackError ||
            (await L.onRequestError(
              ...
              b,
              {
                ...
                routePath: e,
                routeType: "render",
                revalidateReason: (0, g.getRevalidateReason)({
    ...
    a.s(["__next_app__", 0, K, "handler", () => M, "routeModule", 0, L], 44041),
      a.i(44041),
      a.s(
        [
          "ClientPageRoot",
...
//# sourceMappingURL=_a54a9f0e._.js.map

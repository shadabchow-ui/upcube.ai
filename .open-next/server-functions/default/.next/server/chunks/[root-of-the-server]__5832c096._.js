...
`);
  ...
  (e) => {
    ...
    async function E({ params: e }) {
      let t = await (0, w.getPage)(e.page),
    ...
    let _ = new t.AppRouteRouteModule({
        ...
        relativeProjectDir: "",
        resolvedPagePath:
          "[project]/app/[page]/opengraph-image--route-entry.js",
    ...
    async function j(e, t, a) {
      var R;
      let w = "/[page]/opengraph-image/route";
      w = w.replace(/\/index$/, "") || "/";
      ...
      let {
        ...
        M = !!(A.dynamicRoutes[k] || A.routes[P]);
      if (M && !C) {
        let e = !!A.routes[P],
          t = A.dynamicRoutes[k];
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5832c096._.js.map

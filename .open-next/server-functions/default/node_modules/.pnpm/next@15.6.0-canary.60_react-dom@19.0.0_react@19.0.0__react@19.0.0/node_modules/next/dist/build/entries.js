            ...
            runDependingOnPageType({
                ...
                onServer: ()=>{
                    if (pagesType === 'app' && appDir) {
                        ...
                        .replace(_constants.PROXY_FILENAME, _constants.MIDDLEWARE_FILENAME).replace('src/', '')] = getEdgeServerEntry({
                            ...params,
                            rootDir,
                ...
                onEdgeServer: ()=>{
                    ...
                    if (isInstrumentation) {
                        ...
                        const edgeServerBundlePath = (0, _utils.isMiddlewareFile)(page) ? serverBundlePath.replace(_constants.PROXY_FILENAME, _constants.MIDDLEWARE_FILENAME).replace('src/', '') : serverBundlePath;

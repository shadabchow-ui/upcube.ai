        ...
        flightData = (await (0, _walktreewithflightrouterstate.walkTreeWithFlightRouterState)({
            ...
            rscHead: /*#__PURE__*/ (0, _jsxruntime.jsxs)(_react.default.Fragment, {
                children: [
                    ...
                    /*#__PURE__*/ (0, _jsxruntime.jsx)(Viewport, {}, getFlightViewportKey(requestId)),
                    /*#__PURE__*/ (0, _jsxruntime.jsx)(Metadata, {}, getFlightMetadataKey(requestId))
                ]
 ...
 */ async function generateDynamicFlightRenderResult(req, ctx, requestStore, options) {
    ...
    const flightReadableStream = _workunitasyncstorageexternal.workUnitAsyncStorage.run(requestStore, componentMod.renderToReadableStream, RSCPayload, clientReferenceManifest.clientModules, {
        onError,
...
function App({ reactServerStream, reactDebugStream, preinitScripts, clientReferenceManifest, ServerInsertedHTMLProvider, nonce, images }) {
    preinitScripts();
    const response = _react.default.use((0, _useflightresponse.useFlightStream)(reactServerStream, reactDebugStream, clientReferenceManifest, nonce));
    ...
    try {
       ...
       */ // The prerender controller represents the lifetime of the prerender. It
            ...
            if (serverIsDynamic || hasFallbackRouteParams) {
                ...
                if (postponed != null) {
                    // Dynamic HTML case
                    metadata.postponed = await (0, _postponedstate.getDynamicHTMLPostponedState)(postponed, preludeIsEmpty ? _postponedstate.DynamicHTMLPreludeState.Empty : _postponedstate.DynamicHTMLPreludeState.Full, fallbackRouteParams, resumeDataCache, experimental.cacheComponents);
                } else {
                    // Dynamic Data case
                    metadata.postponed = await (0, _postponedstate.getDynamicDataPostponedState)(resumeDataCache, experimental.cacheComponents);
                }
       ...
       */ // First we check if we have any dynamic holes in our HTML prerender
            if ((0, _dynamicrendering.accessedDynamicData)(dynamicTracking.dynamicAccesses)) {
                if (postponed != null) {
                    // Dynamic HTML case.
                    metadata.postponed = await (0, _postponedstate.getDynamicHTMLPostponedState)(postponed, preludeIsEmpty ? _postponedstate.DynamicHTMLPreludeState.Empty : _postponedstate.DynamicHTMLPreludeState.Full, fallbackRouteParams, prerenderResumeDataCache, experimental.cacheComponents);
                } else {
                    // Dynamic Data case.
                    metadata.postponed = await (0, _postponedstate.getDynamicDataPostponedState)(prerenderResumeDataCache, experimental.cacheComponents);
                }

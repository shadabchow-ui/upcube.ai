...
async function handler(req, res, ctx) {
    ...
    const prerenderInfo = nextConfig.experimental.ppr && !nextConfig.experimental.cacheComponents && (0, _interceptionroutes.isInterceptionRouteAppPath)(resolvedPathname) ? null : routeModule.match(resolvedPathname, prerenderManifest);
   ...
   */ const couldSupportPPR = (0, _ppr.checkIsAppPPREnabled)(nextConfig.experimental.ppr);
    ...
    (supportsRSCForNavigations && (0, _requestmeta.getRequestMeta)(req, 'onCacheEntryV2') ? // which will generate the RDC for the route. When resuming a Dynamic
    ...
    try {
        ...
        const handleResponse = async (span)=>{
            ...
            const onCacheEntry = supportsRSCForNavigations ? (0, _requestmeta.getRequestMeta)(req, 'onCacheEntryV2') ?? (0, _requestmeta.getRequestMeta)(req, 'onCacheEntry') : (0, _requestmeta.getRequestMeta)(req, 'onCacheEntry');
            if (onCacheEntry) {

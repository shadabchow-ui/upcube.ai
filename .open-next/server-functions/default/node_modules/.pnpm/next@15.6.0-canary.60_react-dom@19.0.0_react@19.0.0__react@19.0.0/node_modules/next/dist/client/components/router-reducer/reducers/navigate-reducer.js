        ...
        for (const normalizedFlightData of flightData){
            ...
            if (newTree !== null) {
                ...
                seedData && isRootRender && postponed) {
                    const task = (0, _pprnavigations.startPPRNavigation)(navigatedAt, new URL(oldCanonicalUrl, url.origin), currentCache, currentTree, treePatch, seedData, head, isHeadPartial, false, scrollableSegments);
                    if (task !== null) {
                        if (task.route === null) {
